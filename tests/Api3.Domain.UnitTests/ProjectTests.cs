...
/// </summary>
/// <remarks>
/// DESIGN: In API 3, Project is a true aggregate root with optimistic concurrency
/// (xmin). The in-memory invariant checks are identical to API 2, but now protected
/// by the aggregate's consistency boundary. These unit tests verify the pure domain
/// logic; concurrency protection is verified by integration tests.
/// </remarks>
