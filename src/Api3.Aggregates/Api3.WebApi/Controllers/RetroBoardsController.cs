...
/// </summary>
/// <remarks>
/// DESIGN: In API 2, there were separate controllers for retro boards and columns.
/// In API 3, column operations are handled here because columns are part of the
/// RetroBoard aggregate. However, the URL structure still exposes columns as a
/// sub-resource of retro boards for REST clarity and test compatibility.
/// </remarks>
[ApiController]
[Route("api")]
