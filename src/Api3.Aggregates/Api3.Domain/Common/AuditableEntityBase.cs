...
///
/// In API 3 derived entities participate in aggregate boundaries. The base
/// class itself stays the same; the structural difference is that child
/// entities are only reachable through their aggregate root.
/// </remarks>
