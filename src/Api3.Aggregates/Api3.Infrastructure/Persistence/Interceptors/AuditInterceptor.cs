...
namespace Api3.Infrastructure.Persistence.Interceptors;
...
/// </summary>
/// <remarks>
/// DESIGN: Identical to API 1/2. By using an interceptor, auditing and soft-delete
/// logic is centralised in one place rather than repeated in every repository or
/// service. The entities themselves remain unaware of this concern — a cross-cutting
