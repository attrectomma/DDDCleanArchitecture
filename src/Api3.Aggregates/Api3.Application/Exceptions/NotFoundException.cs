namespace Api3.Application.Exceptions;
...
/// </summary>
/// <remarks>
/// DESIGN: In API 3 this exception remains in the Application layer because
/// "not found" is an application-level concern — the aggregate root doesn't
/// do database lookups. Services throw this when a repository returns <c>null</c>.
/// Domain entities throw <see cref="Api3.Domain.Exceptions.DomainException"/>
/// for in-memory "not found" scenarios (e.g., column not in aggregate).
/// </remarks>
