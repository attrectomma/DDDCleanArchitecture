namespace Api4.Application.Exceptions;
...
/// </summary>
/// <remarks>
/// DESIGN: Same as API 3. "Not found" remains an application-level concern.
/// In API 4, the VoteService also throws this when a note or vote is not found
/// during cross-aggregate validation.
/// </remarks>
