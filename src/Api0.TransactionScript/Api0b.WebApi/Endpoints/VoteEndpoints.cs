...
/// </summary>
/// <remarks>
/// DESIGN: Identical to Api0a's <see cref="VoteEndpoints"/>. The
/// one-vote-per-user-per-note invariant is checked via a query before insert,
/// which is not safe under concurrency. But in Api0b the middleware catches
/// the DB unique constraint violation (23505) and returns a proper 409.
/// </remarks>
public static class VoteEndpoints
{
        ...
        CancellationToken ct)
    {
        ...
        //    In Api0b, the DB unique constraint catches the race and the middleware
        //    converts it to a 409.
