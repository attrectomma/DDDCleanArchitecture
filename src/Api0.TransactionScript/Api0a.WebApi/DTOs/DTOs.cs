// ── DTOs ─────────────────────────────────────────────────────────
// DESIGN: All DTOs live in a single file in a flat folder. In API 1 these
// are split across Requests/ and Responses/ subfolders in a separate
// Application project. The Transaction Script approach favors fewer
// organizational boundaries — the shapes are identical so the same
// integration test suite can validate the REST contract.

namespace Api0a.WebApi.DTOs;
