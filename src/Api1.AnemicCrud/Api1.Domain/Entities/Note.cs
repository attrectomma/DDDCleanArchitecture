...
/// </summary>
/// <remarks>
/// DESIGN: In API 1 the Note entity is a plain DTO with no behaviour.
/// Note text uniqueness within a column is enforced in the NoteService.
/// Vote count is computed at query time, not stored as a denormalized field.
/// </remarks>
