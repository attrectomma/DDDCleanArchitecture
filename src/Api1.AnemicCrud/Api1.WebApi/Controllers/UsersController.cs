...
/// </summary>
/// <remarks>
/// DESIGN: In API 1 controllers are thin — they accept HTTP requests,
/// delegate to the service layer, and return HTTP responses. No business
/// logic lives here. Error handling is done by the global exception middleware.
/// </remarks>
[ApiController]
[Route("api/users")]
